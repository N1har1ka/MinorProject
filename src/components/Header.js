...
const Header = () => {
    ...
    const isSignupPage = location.pathname === '/signup'||location.pathname==='/login'||location.pathname==='/client-dashboard'||location.pathname==='/worker-dashboard'||location.pathname==='/contractor-dashboard';
  return (
    <>
